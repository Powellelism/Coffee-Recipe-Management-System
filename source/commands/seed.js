...
async function main() {
  ...
  const store5 = await prisma.store.create({
    data: {
      ...
      zip: "94111",
      phone: "415-555-9876",
      email: "info@philzcoffee.com",
    },
  });
  const store6 = await prisma.store.create({
    data: {
      name: "Blue Bottle Coffee",
      address: "753 Valencia St",
      city: "San Francisco",
      state: "CA",
      zip: "94110",
      phone: "415-555-4321",
  ...
  const store7 = await prisma.store.create({
    data: {
      name: "Intelligentsia Coffee",
      address: "1331 W Sunset Blvd",
      city: "Los Angeles",
      state: "CA",
      zip: "90026",
      phone: "213-555-2468",
  ...
  const store8 = await prisma.store.create({
    data: {
      name: "Caribou Coffee",
      ...
      zip: "55403",
      phone: "612-555-1357",
      email: "info@cariboucoffee.com",
    },
  });
  const store9 = await prisma.store.create({
    data: {
      name: "Dutch Bros Coffee",
      address: "1725 NE Cushing Dr",
      city: "Bend",
      state: "OR",
      zip: "97701",
      phone: "541-555-8642",
      email: "info@dutchbros.com",
    },
  });
  const store10 = await prisma.store.create({
    data: {
      ...
      zip: "V5T 3J4",
      phone: "604-555-9753",
      email: "info@groundsforcoffee.com",
    },
  });

  const drink1 = await prisma.food.create({
    data: {
      name: "Espresso",
      price: 2.99,
      storeId: store1.id,
  ...
  const drink2 = await prisma.food.create({
    data: {
      name: "Cappuccino",
      price: 3.99,
      storeId: store2.id,
  ...
  const drink3 = await prisma.food.create({
    data: {
      name: "Latte",
      price: 4.49,
      storeId: store3.id,
  ...
  const drink4 = await prisma.food.create({
    data: {
      name: "Mocha",
      price: 4.99,
      storeId: store4.id,
  ...
  const drink5 = await prisma.food.create({
    data: {
      name: "Americano",
      price: 2.49,
      storeId: store5.id,
  ...
  const drink6 = await prisma.food.create({
    data: {
      name: "Iced Coffee",
      price: 3.49,
      storeId: store6.id,
  ...
  const drink7 = await prisma.food.create({
    data: {
      name: "Chai Latte",
      price: 4.29,
      storeId: store7.id,
  ...
  const drink8 = await prisma.food.create({
    data: {
  ...
  const drink9 = await prisma.food.create({
    data: {
      name: "Hot Chocolate",
      price: 3.29,
      storeId: store9.id,
  ...
  const drink10 = await prisma.food.create({
    data: {
      name: "Iced Tea",
      price: 2.79,
      storeId: store10.id,
  ...
  const ingredient7 = await prisma.ingredient.create({
    data: { name: "Chai Tea Concentrate" },
  });
  const ingredient8 = await prisma.ingredient.create({
    data: { name: "Matcha Green Tea Powder" },
  });
  const ingredient9 = await prisma.ingredient.create({
    data: { name: "Cocoa Powder" },
  });
  const ingredient10 = await prisma.ingredient.create({
    data: { name: "Black Tea" },
  });
  ...
  const recipe1 = await prisma.recipe.create({
    data: {
      ...
      foodId: drink1.id,
      size: "SMALL",
      instructions: "1. Grind and tamp espresso beans\n2. Pull espresso shot",
      totalTime: 2,
    },
  });
  ...
  const recipe4 = await prisma.recipe.create({
    data: {
      ...
      size: "LARGE",
      instructions:
        "1. Pull espresso shot\n2. Add mocha sauce\n3. Steam milk\n4. Pour steamed milk over espresso and mocha sauce",
      totalTime: 6,
    },
  });
  const recipe5 = await prisma.recipe.create({
    data: {
      ...
      foodId: drink5.id,
      size: "SMALL",
      instructions: "1. Pull espresso shot\n2. Add hot water",
      totalTime: 2,
    },
  });
  const recipe6 = await prisma.recipe.create({
    data: {
      name: "Iced Coffee Recipe",
      foodId: drink6.id,
      size: "MEDIUM",
  ...
  const recipe7 = await prisma.recipe.create({
    data: {
      name: "Chai Latte Recipe",
      foodId: drink7.id,
      size: "MEDIUM",
      instructions:
        "1. Steam milk\n2. Add chai tea concentrate\n3. Pour steamed milk over chai tea concentrate",
      totalTime: 4,
    },
  });
  const recipe8 = await prisma.recipe.create({
    data: {
      name: "Green Tea Latte Recipe",
      foodId: drink8.id,
      size: "LARGE",
      instructions:
        "1. Steam milk\n2. Add matcha green tea powder\n3. Pour steamed milk over matcha powder",
      totalTime: 4,
    },
  });
  const recipe9 = await prisma.recipe.create({
    data: {
      ...
      size: "MEDIUM",
      instructions:
        "1. Steam milk\n2. Add cocoa powder\n3. Pour steamed milk over cocoa powder",
      totalTime: 4,
    },
  });
  ...
  await prisma.rating.createMany({
    data: [
      {
        rateableId: recipe1.id,
        rateableType: "Recipe",
        score: 4,
        recipeId: recipe1.id,
      },
      {
        rateableId: recipe2.id,
        rateableType: "Recipe",
        score: 5,
        recipeId: recipe2.id,
      },
      {
        rateableId: recipe3.id,
        rateableType: "Recipe",
        score: 4,
        recipeId: recipe3.id,
      },
      {
        rateableId: recipe4.id,
        rateableType: "Recipe",
        score: 5,
        recipeId: recipe4.id,
      },
      {
        rateableId: recipe5.id,
        rateableType: "Recipe",
        score: 3,
        recipeId: recipe5.id,
      },
      {
        rateableId: recipe6.id,
        rateableType: "Recipe",
        score: 4,
        recipeId: recipe6.id,
      },
      {
        rateableId: recipe7.id,
        rateableType: "Recipe",
        score: 5,
        recipeId: recipe7.id,
      },
      {
        rateableId: recipe8.id,
        rateableType: "Recipe",
        score: 4,
        recipeId: recipe8.id,
      },
      {
        rateableId: recipe9.id,
        rateableType: "Recipe",
        score: 3,
        recipeId: recipe9.id,
      },
      {
        rateableId: recipe10.id,
        rateableType: "Recipe",
        score: 5,
